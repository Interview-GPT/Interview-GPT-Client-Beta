...
//   return <div className='h-screen'>description will be here</div>;
// };
  ...
  return (
    <div className="bg-dark-layer-1">
      ...
      <div className="flex h-11 w-full items-center pt-2 bg-dark-layer-2 text-white overflow-x-hidden">
        <div
          className={
            "bg-dark-layer-1 rounded-t-[5px] px-5 py-[10px] text-xl cursor-pointer"
          }
        >
          Description
        </div>
        ...
        <div className="px-5">
          ...
          <div className="w-full">
            ...
            <div className="flex items-center mt-3">
              <div
                className={`text-black bg-olive inline-block rounded-[21px] bg-opacity-[.15] px-2.5 py-1 text-xs font-medium capitalize `}
              >
                Easy
              </div>
              ...
              <div className="flex items-center cursor-pointer hover:bg-dark-fill-3 space-x-1 rounded p-[3px]  ml-4 text-lg transition-colors duration-200 text-dark-gray-6">
                {/* Replace the icons with desired components */}
                {/* LikeComponent /> */}
                <span className="text-xs">120</span>
              </div>
              <div className="flex items-center cursor-pointer hover:bg-dark-fill-3 space-x-1 rounded p-[3px]  ml-4 text-lg transition-colors duration-200 text-green-s text-dark-gray-6">
                {/* Replace the icons with your desired components */}
                {/* <YourDislikeComponent /> */}
                <span className="text-xs">2</span>
              </div>
              <div className="cursor-pointer hover:bg-dark-fill-3  rounded p-[3px]  ml-4 text-xl transition-colors duration-200 text-green-s text-dark-gray-6 ">
                {/* Replace the icon with your desired component */}
                {/* <YourStarComponent /> */}
              </div>
            </div>

  ...
  return (
    <div>
      ...
      <div className="flex h-11 w-full items-center pt-2 bg-dark-layer-2 text-white overflow-x-hidden">
        <div className="bg-dark-layer1 rounded-t-[5px] px-5 py-[10px] text-lg cursor-pointer">
          Description
        </div>
      </div>
      <div className="bg-dark-layer1">
          ...
          <div className="px-5">
            ...
            <div className="w-full">
              ...
              <div className="flex items-center mt-3">
                <div className="text-green inline-block rounded-[21px] bg-opacity-[.15] px-2.5 py-1 text-lg font-medium capitalize">
                  Easy
                </div>
